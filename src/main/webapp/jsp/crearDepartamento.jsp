...
<body " style="background-color: #343A40">
	...
	<div class="container-fluid">
			...
			<div class="row justify-content-md-center">
				<div class="col-4" style="color: #AEAEAE">
					<label class="form-label">Nombre:</label><br> <input
						type="text" class="form-control" id="txtNombre"><br>
					<label class="form-label">Edificio:</label><br>
		...
		<div class="row justify-content-md-center text-center my-3">
			<div class="col-4" style="color: #AEAEAE">
				<button class="btn btn-danger mx-5" onclick="location.href='MdoAdministradorControlador'">
					<i class="bi bi-x-circle black"></i> Cancelar
				</button>
				<button class="btn btn-primary mx-5"
					onclick="modalCrearDepartamento()">
					<i class="bi bi-arrow-right white"></i> Continuar
				</button>
			</div>
		</div>
	</div>
...
<script>
	function modalCrearDepartamento() {
		...
		$.ajax({
			...
			data : {"txtNombre":nombre,"txtEdificio":edificio},
			method : "POST",
			success: function(){
