                ...
                <ul class="navbar-nav mx-auto me-auto mb-2 mb-lg-0 text-center">
                    <li id="tabCompras" class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-dark bg-dark" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item text-center nav-link" href="RegistrarCompra.html">Listar departamento</a>
                            </li>
                            <li><a class="dropdown-item text-center nav-link" href="ConsultarCompras.html">Crear departamento</a>
                            </li>
                        </ul>
                    </li>
                    <li id="tabEgresos" class="nav-item dropdown">
                        <a class="nav-link text-center px-5" href="#" id="navbarDropdown" role="button"
                         ...
                         <ul class="dropdown-menu dropdown-menu-dark bg-dark" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item text-center nav-link" href="RegistrarCompra.html">Listar Usuario</a>
                            </li>
                            <li><a class="dropdown-item text-center nav-link" href="ConsultarCompras.html">Crear Usuario</a>
                            </li>
                        </ul>
                    </li>
